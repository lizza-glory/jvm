...
public class NameSpace_1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Class<?> clazz_1 = classLoader.loadClass("com.lizza.classloader.ClassLoader_01");
        Class<?> clazz_2 = classLoader.loadClass("com.lizza.classloader.ClassLoader_01");
        System.out.println("clazz_1 == clazz_2 ? " + clazz_2.equals(clazz_1));
        CustomClassLoader_2 classLoader_1 = new CustomClassLoader_2(path);
        Class<?> clazz_3 = classLoader_1.loadClass("com.lizza.classloader.ClassLoader_01");
